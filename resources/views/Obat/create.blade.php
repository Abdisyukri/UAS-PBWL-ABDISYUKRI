            ...
            <div class="card-body">
                <form action="{{ url('/obat')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="obat_nama" class="form-control" placeholder="Nomor Polisi">
                    </div>
                    <div class="mb-3">
                        <label for="">HARGA</label>
                        <input type="text" name="obat_harga" class="form-control" placeholder="Harga Keseluruhan">
                    </div>
                    <div class="mb-3">
                        <label for="">KENDARAAN MASUK</label>
                        <input type="text" name="obat_stock" class="form-control" placeholder="WIB">
                    </div>
                    <div class="mb-3">
